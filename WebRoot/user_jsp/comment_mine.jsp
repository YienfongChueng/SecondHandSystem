...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="shopping1">
	...
	<nav style="text-align: center" id="pageShow">
		<s:if test="currPage != 1">
			<a href="product_searchCommentByPage.action?flag=0&currPage=1" target="content">首页</a>
			<a href="product_searchCommentByPage.action?flag=0&currPage=<s:property value="currPage-1"/>" target="content">上一页</a>
		</s:if>
		<s:if test="currPage != totalPage">
			<a href="product_searchCommentByPage.action?flag=0&currPage=<s:property value="currPage+1"/>" target="content">下一页</a>
			<a href="product_searchCommentByPage.action?flag=0&currPage=<s:property value="totalPage"/>" target="content">尾页</a>
		</s:if>
